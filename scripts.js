 ...
 * @param {string} niche - The niche/topic for the video
 * @returns {Promise<Object>} The parsed script object
 */
 ...
 * @param {string} scriptText - The raw script text from AI
 * @returns {Object} Parsed script object with sections
 */
function parseScript(scriptText) {
  ...
  try {
    ...
    console.error('⚠️  Warning: Error parsing script sections:', error.message);
 ...
 * @returns {Promise<Array>} Array of script file paths
 */
